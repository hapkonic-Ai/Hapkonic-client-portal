...
|-----|-----------------------------------------------|-------------|----------|-----------|--------------------------------|
| 01  | Project Scaffolding & Design System           | Not Started | 0%       | 3–4 days  | [phase-01.md](phase-01.md)     |
...
> **None currently active.** Start with [Phase 01 — Project Scaffolding & Design System](phase-01.md).
